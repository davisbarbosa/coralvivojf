...
import Filters from "./Filters"; // Impor o componentrt, Button } from "react-bootstrap";
...
const FishList = () => {
  ...
  useEffect(() => {
    fetch(process.env.PUBLIC_URL + "/data/fishs.csv")
  ...
  return (
    <>
      <Helmet>
        <title>Coral Vivo JF | Peixes</title>
        <meta
          name="description"
          content="Explore nossa coleção de peixes marinhos ornamentais"
        />
        <meta name="robots" content="index, follow" />

        {/* Open Graph Meta Tags */}
        <meta property="og:title" content="Coral Vivo JF | Peixes" />
        <meta
        ...
        <meta
          property="og:url"
          content="https://www.coralvivojf.com.br/peixes"
        />
        <meta property="og:type" content="website" />

        {/* Twitter Meta Tags */}
        <meta name="twitter:card" content="%PUBLIC_URL%/logo512.png" />
        <meta name="twitter:title" content="Coral Vivo JF | Peixes" />
        <meta
      ...
      >
        <Container>
          <h1 className={`text-center mb-4`}>Nossos peixes</h1>
          <Row className="mb-3">
