...
const ProductDetails = () => {
  ...
  const message = `Olá, tenho interesse no peixe ${product.name} por R$${product.price}.`;
            ...
            >
              ...
              {product.image2 && (
                <Carousel.Item>
                  <img
                    className="d-block w-100"
                    src={process.env.PUBLIC_URL + "/image/peixes/" +product.image2}
                    alt={`${product.name} - 2`}
                  />
                </Carousel.Item>
              )}
              {product.image3 && (
                <Carousel.Item>
                  {isYouTubeLink(product.image3) ? (
                    ...
                    <img
                      className="d-block w-100"
                      src={process.env.PUBLIC_URL + "/image/peixes/" +product.image3}
                      alt={`${product.name} - 3`}
                    />
                  )}
                </Carousel.Item>
